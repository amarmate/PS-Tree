...
from pstree.datasets.synthetic_datasets import (
    # load_synthetic1, 
    load_synthetic2, load_synthetic3, load_synthetic4, load_synthetic5, 
    # load_synthetic6, 
    # load_synthetic7, 
    load_synthetic8, 
    # load_synthetic9, load_synthetic10, 
...
from pstree.datasets.data_loader import ( 
    ...
    load_istanbul, 
    # load_ld50, load_bioav, load_parkinson_updrs, load_ppb, load_resid_build_sale_price,
)
